...
import com.itfvck.wechatframework.api.oauth.protocol.get_access_token.GetAccessTokenRequest;
import com.itfvck.wechatframework.api.oauth.protocol.get_access_token.GetAccessTokenResponse;
import com.itfvck.wechatframework.api.oauth.protocol.get_userinfo.GetUserinfoRequest;
import com.itfvck.wechatframework.api.oauth.protocol.get_userinfo.GetUserinfoResponse;
import com.itfvck.wechatframework.api.oauth.protocol.refresh_access_token.RefreshAccessTokenRequest;
import com.itfvck.wechatframework.api.oauth.protocol.refresh_access_token.RefreshAccessTokenResponse;
import com.itfvck.wechatframework.api.oauth.protocol.valid_access_token.ValidAccessTokenRequest;
import com.itfvck.wechatframework.api.oauth.protocol.valid_access_token.ValidAccessTokenResponse;
...
public class OAuthManager {
    ...
    public static String generateRedirectURI(String redirectURI, String scope, String state) {
        ...
        url.append("?appid=").append(urlEncode(WechatConfig.instance().getAppid()));
     ...
     * <p>
     * 参考<a href=
     * "http://mp.weixin.qq.com/wiki/17/c0f37d5704f0b64713d5d2c37b468d75.html#.E7.AC.AC.E4.B8.89.E6.AD.A5.EF.BC.9A.E5.88.B7.E6.96.B0access_token.EF.BC.88.E5.A6.82.E6.9E.9C.E9.9C.80.E8.A6.81.EF.BC.89">
     * 开发文档</a>
     * </p>
     *
     * @param request
