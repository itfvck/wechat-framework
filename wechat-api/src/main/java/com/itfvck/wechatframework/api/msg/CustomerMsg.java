 ...
 */
package com.itfvck.wechatframework.api.msg;
...
public class CustomerMsg {
	private static Logger logger = LoggerFactory.getLogger(CustomerMsg.class);
	...
	public static void sendVideo(String title, String description, String mediaId, String thumbMediaId, String accsee_token, String toUserOpenId) {
		VideoResponse video = new VideoResponse(mediaId, title, description, thumbMediaId);
	 ...
	 * @param video
	 */
	public static void sendVideo(VideoResponse video, String accsee_token, String toUserOpenId) {
		JSONObject jsonMsg = new JSONObject();
	...
	public static void sendMusic(String title, String description, String musicURL, String hQMusicUrl, String thumbMediaId, String accsee_token, String toUserOpenId) {
		MusicResponse music = new MusicResponse(title, description, musicURL, hQMusicUrl, thumbMediaId);
	 ...
	 *            音乐消息
	 */
	public static void sendMusic(MusicResponse music, String accsee_token, String toUserOpenId) {
		JSONObject jsonMsg = new JSONObject();
	 ...
	 * @param item
	 */
	public static void sendNews(ArticleResponse item, String accsee_token, String toUserOpenId) {
	 ...
	 * @param items
	 */
	public static void sendNews(List<ArticleResponse> items, String accsee_token, String toUserOpenId) {
